      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("sucess", "Logged-Out successfully; See you soon!");
              window.setTimeout(function () {
                location.assign("/");
              }, 900);
            }
...
if (signupForm) {
  signupForm.addEventListener("submit", function (e) {
    ...
    var passwordConfirm = document.getElementById("passwordconfirm").value; // execute a post request using axios to create the user in db
...
if (loginForm) {
  loginForm.addEventListener("submit", function (e) {
    ...
    var email = document.getElementById("email").value;
    var password = document.getElementById("password").value; // execute a post request using axios to log the user in
